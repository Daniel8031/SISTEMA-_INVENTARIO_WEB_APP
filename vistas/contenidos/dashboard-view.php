...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fab fa-dashcube fa-fw"></i> &nbsp; Opciones
    </h3>
    <p class="text-justify">
        ¡Bienvenido <strong><?php echo $_SESSION['nombre_svi']." ".$_SESSION['apellido_svi']; ?></strong>! Este es el panel principal del sistema acá podrá encontrar atajos para acceder a los distintos listados de cada módulo del sistema, si tienes alguna duda contactanos
    </p>
</div>
<div class="container-fluid">
    ...
    <a href="<?php echo SERVERURL; ?>total/" class="tile">
        <div class="tile-tittle">Inversion</div>
        <div class="tile-icon">
